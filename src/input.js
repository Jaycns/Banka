...
function SignIn(props) {
  ...
  return (
    <div>
      <div
        class={`login-box ${
          props.currentTheme === "white" ? "black" : "white"
        }`}
        style={{
          backgroundColor: props.currentTheme === "white" ? "white" : "black",
        }}
      >
        ...
        <form>
          ...
          <div className="jans">
            <span className="reds">
              {formState === "signin" ? "Don't" : "Already"} have an account?
            </span>{" "}
            <button className="blacks" onClick={handleClick}>
              Sign up
            </button>
          </div>
        </form>
